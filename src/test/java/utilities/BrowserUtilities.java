...
public class BrowserUtilities {
    ...
    //static WebDriver driver = Driver.getDriver(); // dikkat -> kullanma
    ...
    @Nullable // read data from properties file
    ...
    // explicit wait, clickable of element, condition
  ...
  const element = document.elementFromPoint(x, y)
    ...
    public static void verifyVideoPlays(WebElement element) {
        ...
        try {
            BrowserUtilities.waitFor(1); // time to play
